        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImgUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ModificationColorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ModificationColors_ModificationColors_ModificationColorId",
                        column: x => x.ModificationColorId,
                        principalTable: "ModificationColors",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModificationColors_ModificationColorId",
                table: "ModificationColors",
                column: "ModificationColorId");
